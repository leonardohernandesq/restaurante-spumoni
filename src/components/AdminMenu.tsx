...
export const AdminMenu = ({ title }: { title: string }) => {
  ...
  const menuSections = [
    {
      ...
      links: [
        ...
        { label: "Configurar frete", href: "/admin/frete" },
      ],
    },
    {
      title: "Produtos",
  ...
  return (
    <header className="flex justify-between items-center">
      ...
      <div
        className={`fixed right-0 top-0 w-96 h-screen bg-white z-50 ${
          isOpen ? "block" : "hidden"
        }`}
      >
        <div className="p-4">
          <button
            ...
            className="fixed right-3 top-3 text-zinc-400 cursor-pointer mb-4"
          >
            <FiXCircle size={30} />
          </button>
