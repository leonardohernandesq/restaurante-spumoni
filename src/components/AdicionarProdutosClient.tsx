...
export function AdicionarProdutosClient() {
            ...
            <section className="relative py-5 gap-1 flex flex-col">
                <div className="flex flex-col">
                    ...
                    <label className="mt-1 inline-flex items-center cursor-pointer w-fit">
                        <input type="checkbox" className="sr-only peer" checked={formData.ativo} onChange={() => handleChange("ativo", !formData.ativo)} />
                ...
                <select value={formData.categoria_id} onChange={(e) => handleChange("categoria_id", e.target.value)} className="bg-zinc-200 border border-zinc-300 py-1.5 px-3 outline-0">
                ...
                <input value={formData.preco} onChange={(e) => handleChange("preco", e.target.value)} className="bg-zinc-200 border border-zinc-300 py-1.5 px-3 outline-0" placeholder="Ex: 49.90" />
                                ...
                                <div key={j} className="grid grid-cols-3 gap-2 mb-2">
                                    ...
                                    <label className="flex items-center">
                                        <input
                                            ...
                                            onChange={(e) => updateValor(i, j, "preco_incluido", e.target.checked)}
                                            className="w-4 h-4"
                                        />
