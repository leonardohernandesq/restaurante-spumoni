    ...
    return (
        <Container>
            <div className='flex flex-col items-center justify-center py-14 lg:h-screen lg:py-0'>
                ...
                <h1 className='text-4xl text-center font-medium text-green-principal-900 mb-12'>
                ...
                <div className='flex flex-col-reverse lg:flex-row items-center gap-10'>
                    ...
                    <section className='flex w-full flex-col'>
                        <p className='py-2'>
                            ...
                            Seu pedido foi recebido com sucesso e está sendo preparado com todo carinho e dedicação para garantir a melhor experiência gastronômica.
                        </p>
                        <p className='py-2'>
                            Fique tranquilo, estamos cuidando de tudo para que sua refeição chegue até você com frescor e sabor!
                        </p>
                        <p className='py-2'>
                            Aproveite seu momento e, caso queira, não deixe de nos acompanhar nas redes sociais para mais novidades e promoções exclusivas!
                        </p>
                        ...
                        <h2 className='text-lg'>
                            Equipe <span className='text-purple-principal-900 font-medium'>Spumoni</span>
                        </h2>
                    </section>
                </div>
            </div>
