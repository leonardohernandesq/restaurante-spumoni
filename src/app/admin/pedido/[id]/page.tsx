        ...
        <Container styleRow='bg-zinc-100' styleContainer='min-h-screen'>
            ...
            <section className='relative py-5 flex flex-col gap-4'>
                <div className=' p-2.5 border border-zinc-300 w-full rounded-md'>
                    ...
                    {pedido?.status && (
                        <div className={`my-2 px-3 py-1 ${getColor(pedido.status)} text-white rounded-md w-fit`}> {getLabel(pedido.status)}</div>
                    )}
                ...
                <div className='p-2.5 border border-zinc-300 w-full rounded-md'>
                    <p>Delivery: <span className='font-medium'> R${pedido?.taxa_entrega}</span></p>
                    <p>Total: <span className='font-medium'> R${pedido?.valor_total}</span></p>
                    <p>Forma de Pagamento: <span className='font-medium'> PIX</span></p>
                </div>

                <div className='w-full rounded-md flex border border-zinc-300'>
                    <button onClick={() => handleSendNotification(0)} className='w-full text-center flex flex-col items-center gap-2 border-r border-zinc-300 p-3 cursor-pointer'>
                        <FaTrashAlt size={20} />
                    ...
                    <button onClick={() => handleSendNotification(3)} className='w-full text-center flex flex-col items-center gap-2 border-r border-zinc-300 p-3 cursor-pointer'>
                        <FaMotorcycle size={20} />
                        <p className='text-sm/4 font-medium '>Saiu para Entrega</p>
                    </button>
                    <button onClick={() => handleSendNotification(4)} className='w-full text-center flex flex-col items-center gap-2 border-r border-zinc-300 p-3 cursor-pointer'>
