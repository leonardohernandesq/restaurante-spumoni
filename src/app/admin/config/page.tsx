          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-5">
            {openingHours.map((item, index) => {
              ...
              const diasDisponiveis = diasSemana.filter(
                (d) =>
                  d.value === item.dia_semana || !usedDays.includes(d.value)
              );

              return (
                <div
                  key={index}
                  className="border border-zinc-300 p-3 rounded-md bg-zinc-100"
                >
                  <label htmlFor={`horario_abertura_${index}`}>
                    Horário de Abertura
                  </label>
                  <input
                    type="time"
                  ...
                  <label
                    className="mt-3"
                    htmlFor={`horario_fechamento_${index}`}
                  >
                  ...
                  <label className="mt-3" htmlFor={`dia_semana_${index}`}>
                    Dia da Semana
                  </label>
                  <select
                  ...
                  <label className="mt-3" htmlFor={`observacao_${index}`}>
                    Observação
                  </label>
                  <textarea
